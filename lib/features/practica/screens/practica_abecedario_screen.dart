// lib/features/practica/screens/practica_abecedario_screen.dart
...
class PracticaAbecedarioScreen extends StatefulWidget {
  const PracticaAbecedarioScreen({super.key});

  @override
  State<PracticaAbecedarioScreen> createState() => _PracticaAbecedarioScreenState();
}

class _PracticaAbecedarioScreenState extends State<PracticaAbecedarioScreen> {
  final List<Offset?> _puntos = [];
  final GlobalKey _canvasKey = GlobalKey();
  final Random _random = Random();

  late List<String> _letras;
  ...
  void initState() {
    super.initState();
    final letrasBase = DatosAbecedario.obtenerLetras();
    _letras = [
      for (final letra in letrasBase) letra.letraMayuscula,
      for (final letra in letrasBase) letra.letraMinuscula,
    ];
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            'Has trazado la letra $_letraActual muy bien.',
